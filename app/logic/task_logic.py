...
def add_task_logic(user_email, task_name, task_priority):
    ...
    :param user_email: Email del usuario que crea la tarea.
    :param task_name: Nombre de la tarea.
    :param task_priority: Prioridad de la tarea.
    ...
    # Crear un diccionario con los datos de la tarea, incluyendo el user_id
    task_data = {
        'name': task_name,
    ...
    user_tasks = user_list[0].get('tasks', [])  # Obtener tareas existentes (si las hay)
    user_tasks.append(ObjectId(inserted_id))  # Añadir la nueva tarea al usuario
